"This script downloads TACO's images from Flickr given an annotation json file Code written by Pedro F. Proenza, 2019"
...
parser.add_argument('--dataset_path', required=False, default= '/content/annotations.json', help='Path to annotations')
